...
### GitHub:
- [ECS powered prototype of an autobattle between two teams](https://github.com/vikle/unity-test-p5-main)
- [Lightweight and easy-to-use ECS framework for Unity](https://github.com/vikle/UniversalEntities)
- [URP render feature for custom post process effects](https://github.com/vikle/URPImageEffectsAdapter)
- [Realization of wave function collapse using the arc-consistency 3 algorithm](https://github.com/vikle/WFC-AC3)
